...
<div id="banner"><div style="background-image:url(uploadfile/about.jpg);"></div>
</div>
...
您的位置：<a href="index.html">首页</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;<a href="<?php echo $CAT['url'];?>"><?php echo $CAT['catname'];?></a></a>
</div>
<div class="content">
